...
This is the third in a series of four analytical reports examining Ayr town centre. The [first report](simd-ayr-town-centre.qmd) mapped deprivation across the study area using the Scottish Index of Multiple Deprivation. The [second report](local-economy.qmd) profiled the town centre's employment base and built the economic case against residential surrender. This report addresses **accessibility** --- the physical infrastructure that enables or prevents people from reaching the town centre. The [fourth report](../docs/gravity-model-framework.qmd) develops a gravity model framework for understanding the competitive relationship between Ayr and Prestwick.

The project's theory of change identifies poor access as the *starting point* of a vicious cycle: poor access leads to reduced footfall, which leads to business closures, which makes the town centre less attractive, which drives further loss of footfall and demand, which weakens the economic base, which leads to further underinvestment in access. If this theory is correct, then improving access is not just one of many possible interventions --- it is the *most upstream* intervention available.
...
- **Realignment of the A70**, which currently runs through Burns Statue Square as a major traffic route, creating a barrier to pedestrian and vehicle access from the south and east of Ayr
- **An enlarged pedestrian public space** extending from Station Road to Smith Street
- ~~**An active travel route** linking the town centre to Prestwick Airport~~ --- **discontinued** following consultation feedback [@dailyrecord2025ayrcyclelanes]

Construction is targeted for summer 2026. The Pride in Place programme [@ukgov2025prideinplace] begins funding from April 2026, though it targets Northern Ayr (north of the River Ayr) rather than the town centre proper where Burns Statue Square sits.
...
The mean distance to the nearest pedestrian crossing is `r tc_cross_dist` metres in the Town Centre and `r wa_cross_dist` metres in Wider Ayr. But density alone does not capture the problem. The A70, which runs through Burns Statue Square, creates a specific barrier to access from the south and east of Ayr. The square functions as a traffic island, hostile to pedestrians approaching the town centre from surrounding residential areas and from the adjacent railway station. The Burns Statue Square project directly addresses this by realigning the A70 through New Bridge Street, improving traffic flow and creating a contiguous pedestrian zone.
...
The Burns Statue Square project originally included an active travel route linking the town centre to Prestwick Airport. However, this element has been **discontinued** following consultation feedback --- South Ayrshire Council confirmed that there will be no cycle lanes in Alloway Street, Sandgate, or Fullarton Street [@dailyrecord2025ayrcyclelanes]. This is a missed opportunity: an active travel link would have extended the town centre's connectivity to a regional transport hub and supported car-free access for bus-dependent populations.
...
Ayr Railway Station sits on the Glasgow--Ayr line, providing direct rail connections to Glasgow Central. The mean distance from town centre datazones to the station is `r comma(tc_rail_dist)` metres. The current A70 alignment creates a barrier between the station and the commercial centre --- a barrier that the Burns Statue Square project proposes to address through road realignment.

However, the significance of rail-generated footfall for Ayr town centre is debatable. South Ayrshire Council's case for the Burns Statue Square redevelopment emphasises the station-to-town-centre connection, but there are reasons for scepticism. Ayr is the **southern terminus** of the Glasgow line: most arriving passengers are residents, not visitors. Towns to the north --- Kilwinning, Irvine, and Troon --- are closer by rail to Prestwick, which offers a concentrated hospitality offering with ample parking. The southern rail catchment (Maybole, Girvan) has limited populations. Major social infrastructure --- further education college, university, local authority headquarters, and the main leisure centre --- is located away from the town centre, reducing the pull for rail visitors specifically.

The A70 barrier is real, but its primary impact may be on **general vehicle and pedestrian access from the south-east** rather than on rail-to-town-centre footfall. Improving traffic flow and pedestrian permeability at Burns Statue Square would benefit all modes of access, not just rail passengers.
...
3. **The A70 is the single biggest barrier.** Burns Statue Square functions as a traffic island, creating a hostile environment for pedestrians and vehicles approaching the town centre from the south and east. The Burns Statue Square project [@southayrshire2025burnsstatue] directly addresses this by realigning the road and creating a pedestrian zone. The primary benefit is likely to be improved traffic flow and general pedestrian access rather than rail-generated footfall specifically (see the [discussion above](#railway-connectivity)).
...
5. **The investment window is open --- but geographically split.** The Burns Statue Square project (GBP 16 million) targets the town centre directly. The Pride in Place programme [@ukgov2025prideinplace] (up to GBP 20 million over 10 years) funds regeneration in Northern Ayr, north of the River Ayr --- adjacent to the town centre but not within it. Realising the combined potential of these investments will require deliberate coordination between the two programmes, not an assumption that they naturally overlap.
...
graph TD
    ...
    H["Burns Statue Square:<br/>A70 realignment and<br/>pedestrian zone"] -.-> A
    H -.-> B
    I["Pride in Place:<br/>Northern Ayr regeneration<br/>(indirect benefit)"] -.-> A
    I -.-> D
