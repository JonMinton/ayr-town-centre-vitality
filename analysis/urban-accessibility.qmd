...
plot_infrastructure_map(
  sa, infra$car_parks, "Car parks",
  point_colour = INFRA_PALETTE["Car parks"],
  point_size = 2.5,
  title = "Car Park Locations",
...
plot_infrastructure_map(
  sa, infra$crossings, "Pedestrian crossings",
  point_colour = INFRA_PALETTE["Pedestrian crossings"],
  title = "Pedestrian Crossing Locations",
...
plot_line_infrastructure_map(
  sa, infra$cycle_paths, "Cycle paths",
  line_colour = INFRA_PALETTE["Cycle paths"],
  title = "Cycle Path Network",
...
plot_infrastructure_map(
  sa, infra$railway_stations, "Railway stations",
